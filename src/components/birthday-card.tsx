...
export function BirthdayCard({
	...
	return (
		<View style={styles.card}>
			<TouchableOpacity
				onPress={() => console.log(`Navigate to /contato/${birthday.id}`)}
			>
							...
							<View>
								...
								{birthday.age !== undefined && (
									<Text style={styles.age}>
										{birthday.isToday
											? `${birthday.age} anos hoje!`
											: `Fará ${birthday.age + 1} anos`}
									</Text>
								)}
							</View>
						...
						{!birthday.isToday && birthday.isSoon && (
							<View style={styles.soonBadge}>
								<Text style={styles.soonText}>
									Em {birthday.daysUntil}{" "}
									{birthday.daysUntil === 1 ? "dia" : "dias"}
								</Text>
							</View>
						)}
